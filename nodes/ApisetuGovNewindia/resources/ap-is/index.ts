...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					"name": "Egipc",
					"value": "Egipc",
					"action": "Insurance Policy - Engineering",
					"description": "API to verify Insurance Policy - Engineering.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/egipc/certificate"
						}
					}
				},
				{
					"name": "Hlipc",
					"value": "Hlipc",
					"action": "Insurance Policy - Health",
					"description": "API to verify Insurance Policy - Health.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/hlipc/certificate"
						}
					}
				},
				{
					"name": "Miipc",
					"value": "Miipc",
					"action": "Insurance Policy - Miscellaneous",
					"description": "API to verify Insurance Policy - Miscellaneous.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/miipc/certificate"
						}
					}
				},
				{
					"name": "Tripc",
					"value": "Tripc",
					"action": "Insurance Policy - Travel",
					"description": "API to verify Insurance Policy - Travel.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/tripc/certificate"
						}
					}
				},
				{
		...
		{
			"displayName": "POST /egipc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /hlipc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /miipc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /tripc/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
